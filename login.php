...
<body style="height: 3000px;">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-primary sticky-top">
        <div class="container-lg">
            <a class="navbar-brand" href="#"><i class="bi bi-airplane-engines"></i> AL-Fajr</a>
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link link-dark" href="login.php"><i class="bi bi-box-arrow-in-right"></i>
                                            Log-in</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link link-dark" href="checkout.php"><i class="bi bi-telephone-forward"></i>
                                            Check-out</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link link-dark" href="why_us.php">Why us?</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
